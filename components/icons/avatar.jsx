export const Avatar = ({size= 20}) => {
  return <svg
    ...
    y="0px"
    viewBox="0 0 145 145"
    style={{ enableBackground: "new 0 0 145 145", borderRadius: '50%' }}
    xmlSpace="preserve"
  >
    <g id="men_5">
      ...
      <g>
        <g>
          <g>
            <g>
              <path
                style={{ fill: "#F1C9A5" }}
                d="M109.374,115.394c-4.964-9.396-36.875-15.292-36.875-15.292s-31.91,5.896-36.874,15.292
                      C31.957,128.433,28.888,145,28.888,145h43.611h43.612C116.112,145,114.04,127.236,109.374,115.394z"
              />
              <path
                style={{ fill: "#E4B692" }}
                d="M72.499,100.102c0,0,31.911,5.896,36.875,15.292c4.665,11.842,6.737,29.606,6.737,29.606H72.499
                      V100.102z"
              />
              <rect
                x="63.813"
              ...
              <path
                ...
                d="M63.813,94.474c1.563,4.485,7.868,7.057,12.499,7.057
                      c1.676,0,3.306-0.281,4.875-0.795V81H63.813V94.474z"
              />
              <path
                style={{ fill: "#F1C9A5" }}
                d="M94.837,62.653c0-18.162-10.001-28.489-22.338-28.489c-12.336,0-22.337,10.327-22.337,28.489
              ...
              <path
                style={{ fill: "#F1C9A5" }}
                d="M45.161,67.031c-0.684-4.957,2.046-9.318,6.092-9.74c4.053-0.422,7.888,3.259,8.567,8.216
                      c0.683,4.953-2.053,9.315-6.1,9.739C49.671,75.665,45.84,71.988,45.161,67.031z"
              />
              <path
                style={{ fill: "#E4B692" }}
                d="M94.837,62.653c0-18.162-10.001-28.489-22.338-28.489v61.375
                      C84.837,95.539,94.837,86.063,94.837,62.653z"
              />
              <path
                style={{ fill: "#102F41" }}
                d="M109.374,115.394c-3.181-6.021-17.418-10.601-27.242-13.117
        ...
        <path
          style={{ fill: "#231F20" }}
          d="M53.941,84.27c4.859,8.252,9.698,9.528,9.698,9.528l1.466,4.755H63h-1.65l-0.915-2.051H58.42
        ...
        <path
          style={{ fill: "#231F20" }}
          d="M90.629,84.27c-4.669,8.252-9.318,9.528-9.318,9.528l-1.408,4.755h2.022h1.585l0.88-2.051h1.937
        ...
        <path
          style={{ fill: "#E4B692" }}
          d="M91.438,75.246c-4.05-0.424-6.783-4.787-6.098-9.739c0.677-4.957,4.513-8.638,8.563-8.216
